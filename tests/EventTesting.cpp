...
int main()
{
    ...
    zUI::zWidget::zButton* Button1 = zUI::zWidget::createButton(TestWindow, 1, zUI::zCore::zEnumerations::SCALE_ALL, zUI::zCore::zEnumerations::ALIGN_BOTTOM | zUI::zCore::zEnumerations::ALIGN_RIGHT, 10, 10, 50, 50, EvtDispatch);
