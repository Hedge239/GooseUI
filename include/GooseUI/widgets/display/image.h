#ifndef _GOOSEUI_IMAGE_H_
#define _GOOSEUI_IMAGE_H_
...
namespace goose
{
    namespace widgets
    {
        namespace display
        {
            class image : public core::templates::widget::base
            {
                ...
                public:
                image(widgets::base::window* window, core::enumerations::componentScale componentScaleing, int componentAlign, int X, int Y, int Width, int Height);
                ~image() = default;
