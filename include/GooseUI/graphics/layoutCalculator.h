    ...
    namespace graphics
    {
        namespace layout
        {
            class calculator
            {
                ...
                static void calculateLayout(core::types::componentScale scaleMode, int alignments, core::types::sizeRestraints sizeRestraints, int distanceArray[4], int windowWidth, int windowHeight, int& X, int& Y, int& Width, int& Height);
            };
        }
    }
}
